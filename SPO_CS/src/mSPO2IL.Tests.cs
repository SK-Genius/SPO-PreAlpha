					...
					AssertModuleDefs(
						...
						[
							...
							[ // Def 2   => (.Fib(b .- 2)) .+ (.Fib(b .- 1))
								("_...-... := §2ND ENV", (7, 35), (10, 2)),
								("t_14 := §1ST ENV", (7, 35), (10, 2)),
								("_Fib... := §2ND t_14", (7, 35), (10, 2)),
								("t_15 := §1ST t_14", (7, 35), (10, 2)),
								("_...+... := §2ND t_15", (7, 35), (10, 2)),
								("t_16 := §1ST t_15", (7, 35), (10, 2)),
								("_b := ARG", (9, 3), (9, 44)),
							...
							[ // Def 4    Def_Fib...
								...
								("t_9 := §1ST ENV", (7, 16), (10, 2)),
								("d_2 := §2ND t_9", (7, 16), (10, 2)),
								("t_10 := §1ST t_9", (7, 16), (10, 2)),
								("_...-... := §2ND t_10", (7, 16), (10, 2)),
								("t_11 := §1ST t_10", (7, 16), (10, 2)),
								("_Fib... := §2ND t_11", (7, 16), (10, 2)),
								("t_12 := §1ST t_11", (7, 16), (10, 2)),
								("_...+... := §2ND t_12", (7, 16), (10, 2)),
								("t_13 := §1ST t_12", (7, 16), (10, 2)),
								("d_1 := §2ND t_13", (7, 16), (10, 2)),
								("t_14 := §1ST t_13", (7, 16), (10, 2)),
								("d_0 := §2ND t_14", (7, 16), (10, 2)),
								("t_15 := §1ST t_14", (7, 16), (10, 2)),
								("_a := ARG", (7, 17), (7, 29)),
								("t_1 := EMPTY, d_0", (7, 35), (10, 2)),
								("t_2 := t_1, d_1", (7, 35), (10, 2)),
								("t_3 := t_2, _...+...", (7, 35), (10, 2)),
								("t_4 := t_3, _Fib...", (7, 35), (10, 2)),
								("t_5 := t_4, _...-...", (7, 35), (10, 2)),
								("t_6 := t_5, d_2", (7, 35), (10, 2)),
								("t_7 := .d_3 t_6", (7, 35), (10, 2)),
								("t_8 := .t_7 _a", (7, 35), (10, 2)),
								("§RETURN t_8 IF TRUE", (7, 35), (10, 2)),
							],
							[ // Def 5    RecFactory
								("d_4 := §2ND ENV", (6, 1), (11, 1)),
								("t_9 := §1ST ENV", (6, 1), (11, 1)),
								("d_3 := §2ND t_9", (6, 1), (11, 1)),
								("t_10 := §1ST t_9", (6, 1), (11, 1)),
								("d_2 := §2ND t_10", (6, 1), (11, 1)),
								("t_11 := §1ST t_10", (6, 1), (11, 1)),
								("_...-... := §2ND t_11", (6, 1), (11, 1)),
								("t_12 := §1ST t_11", (6, 1), (11, 1)),
								("_...+... := §2ND t_12", (6, 1), (11, 1)),
								("t_13 := §1ST t_12", (6, 1), (11, 1)),
								("d_1 := §2ND t_13", (6, 1), (11, 1)),
								("t_14 := §1ST t_13", (6, 1), (11, 1)),
								("d_0 := §2ND t_14", (6, 1), (11, 1)),
								("t_15 := §1ST t_14", (6, 1), (11, 1)),
								("_Fib... := ARG", (7, 2), (10, 2)),
								("t_1 := EMPTY, d_0", (7, 2), (10, 2)),
								("t_2 := t_1, d_1", (7, 2), (10, 2)),
								("t_3 := t_2, _...+...", (7, 2), (10, 2)),
								("t_4 := t_3, _Fib...", (7, 2), (10, 2)),
								("t_5 := t_4, _...-...", (7, 2), (10, 2)),
								("t_6 := t_5, d_2", (7, 2), (10, 2)),
								("t_7 := t_6, d_3", (7, 2), (10, 2)),
								("t_8 := .d_4 t_7", (7, 2), (10, 2)),
								("§RETURN t_8 IF TRUE", (6, 1), (11, 1))
							],
							[ // Def 6    Init
								("d_5 := §2ND ENV", (1, 1), (13, 14)),
								("t_13 := §1ST ENV", (1, 1), (13, 14)),
								("d_4 := §2ND t_13", (1, 1), (13, 14)),
								("t_14 := §1ST t_13", (1, 1), (13, 14)),
								("d_3 := §2ND t_14", (1, 1), (13, 14)),
								("t_15 := §1ST t_14", (1, 1), (13, 14)),
								("d_2 := §2ND t_15", (1, 1), (13, 14)),
								("t_16 := §1ST t_15", (1, 1), (13, 14)),
								("d_1 := §2ND t_16", (1, 1), (13, 14)),
								("t_17 := §1ST t_16", (1, 1), (13, 14)),
								("d_0 := §2ND t_17", (1, 1), (13, 14)),
								("t_18 := §1ST t_17", (1, 1), (13, 14)),
								("t_1 := §2ND ARG", (1, 9), (4, 1)),
								("_...-... := t_1", (3, 2), (3, 38)),
								("t_2 := §1ST ARG", (1, 9), (4, 1)),
								("t_3 := §2ND t_2", (1, 9), (4, 1)),
								("_...+... := t_3", (2, 2), (2, 38)),
								("t_4 := §1ST t_2", (1, 9), (4, 1)),
								("t_5 := EMPTY, d_0", (6, 1), (11, 1)),
								("t_6 := t_5, d_1", (6, 1), (11, 1)),
								("t_7 := t_6, _...+...", (6, 1), (11, 1)),
								("t_8 := t_7, _...-...", (6, 1), (11, 1)),
								("t_9 := t_8, d_2", (6, 1), (11, 1)),
								("t_10 := t_9, d_3", (6, 1), (11, 1)),
								("t_11 := t_10, d_4", (6, 1), (11, 1)),
								("§REC t_12 := .d_5 t_11", (6, 1), (11, 1)),
								("_Fib... := t_12", (7, 2), (10, 2)),
